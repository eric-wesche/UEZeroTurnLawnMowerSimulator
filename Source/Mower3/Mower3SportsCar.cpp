...
#include "Mower3SportsCar.h"
#include "Mower3SportsWheelFront.h"
#include "Mower3SportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "MowerVehicleMovementComponent.h"

AMower3SportsCar::AMower3SportsCar(const FObjectInitializer& ObjectInitializer) :
Super(ObjectInitializer.SetDefaultSubobjectClass<UMowerVehicleMovementComponent>(VehicleMovementComponentName))
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMower3SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMower3SportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMower3SportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMower3SportsWheelRear::StaticClass();
